...
<html lang="en">
    ...
    <body>
        ...
        <div class="mn-content fixed-sidebar">
                ...
                <nav class="purple darken-1">
                    <div class="nav-wrapper row">
                        ...
                        <div class="header-title col s4">
                            <span class="chapter-title">LAWINGTON Employee Leave Management System</span>
                        </div>
            ...
            <aside id="slide-out" class="side-nav cyan fixed">
            ...
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title"><h4>Welcome to Lawington Employee Leave Management System</h4></div>
